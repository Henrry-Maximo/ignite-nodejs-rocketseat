/* 
  watchedlist -> um array
  initial = [1, 2, 3] (id dos anexos das perguntas)
  new = [4, 5] (id dos anexos novos)
  removed = [2, 3] (id dos anexos que seram removidos)
  currentItems = [1, 4, 5] (valor atual após adições/remoções)
  Obs.: não se perde as referências das modifições executadas
*/
